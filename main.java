...
System.out.println("--------------------------------------------------------------------------------"); System.out.print("Date: " + months[calendar.get(Calendar.MONTH)] + " " + calendar.get(Calendar.DATE) + " " + calendar.get(Calendar.YEAR));
...
d[0].did = "21"; d[0].dname = "Dr.ADNAN"; d[0].specilist = "Heart Specialist"; d[0].appoint = "10-4"; d[0].doc_qual = "Mbbs,Md"; d[0].droom = 17;

d[1].did = "32"; d[1].dname = "Dr.Akheel"; d[1].specilist = "ENT"; d[1].appoint = "10-4"; d[1].doc_qual = "mbbs,md"; d[1].droom = 45;

d[2].did = "17"; d[2].dname = "Dr.CHARITH"; d[2].specilist = "Child Specialist"; d[2].appoint = "10-4"; d[2].doc_qual = "bdm"; d[2].droom = 8;

d[3].did = "33"; d[3].dname = "Dr.AMAR"; d[3].specilist = "DENTIST"; d[3].appoint = "10-4"; d[3].doc_qual = "mbbs,ms"; d[3].droom = 40;

p[0].pid = "12"; p[0].pname = "ABHISHEK"; p[0].disease = "Cancer Specialist"; p[0].sex = "male"; p[0].admit_status = "y"; p[0].age = 30;

p[1].pid = "13"; p[1].pname = "deepu"; p[1].disease = "cold"; p[1].sex = "male"; p[1].admit_status = "y"; p[1].age = 23;

p[2].pid = "14"; p[2].pname = "chandru"; p[2].disease = "malaria"; p[2].sex = "male"; p[2].admit_status = "y"; p[2].age = 45;

p[3].pid = "15"; p[3].pname = "ravi"; p[3].disease = "diabeties"; p[3].sex = "male"; p[3].admit_status = "y"; p[3].age = 25;
...
m[2].med_name = "Dolo"; m[2].med_comp = "cipla"; m[2].exp_date = "12-7-17"; m[2].med_cost = 50; m[2].count = 56;

m[3].med_name = "saaz"; m[3].med_comp = "raj pvt"; m[3].exp_date = "12-4-12"; m[3].med_cost = 1100; m[3].count = 100;
...
s[4].sid="55"; s[4].sname ="mahesh"; s[4].desg="security"; s[4].sex="male"; s[4].salary=15000;
